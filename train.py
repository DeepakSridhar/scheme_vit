...
from timm.models import create_model, safe_model_name, resume_checkpoint, load_checkpoint, \
    convert_splitbn_model, model_parameters #convert_sync_batchnorm, set_fast_norm
from timm.optim import create_optimizer_v2, optimizer_kwargs
from timm.scheduler import create_scheduler
# from timm.utils import ApexScaler, NativeScaler
from apex_utils import ApexScalerAccum as ApexScaler
from apex_utils import NativeScalerAccum as NativeScaler
import metaformer_baselines
from misc_utils.checkpoint_saver import CheckpointSaver
...
def main():
    ...
    log_file = os.path.join(args.output, args.experiment, 'logs.log')
    ...
    is_model_ckpt = os.path.join(args.output, args.experiment,'last.pth.tar')
    if os.path.exists(is_model_ckpt):
        args.resume = is_model_ckpt
    resume_epoch = None
    if args.resume:
